...
tesseract_app_name = 'tesseract' # Name of executable to be called at command line
...
def call_tesseract(input_filename, output_filename):
	...
	args = [tesseract_app_name, input_filename, output_filename]
	proc = subprocess.Popen(args)
	retcode = proc.wait()
	print "return code is %s" % (retcode)
	if retcode != 0:
		raise Exception("An error occurred parsing the image file")
